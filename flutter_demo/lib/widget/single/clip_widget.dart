          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: const Text(
                  '椭圆裁剪，可容纳一个子组件，并将其以宽高为⻓轴和短轴进行椭圆裁切。',
                  style: descStyle,
                ),
              ),
              Wrap(
              ...
              Container(
                ...
                child: const Text(
                  '矩形裁剪，可容纳一个子组件，并将其进行矩形裁切，可借助SizedBox、Align、AspectRadio等限定组件。',
                  style: descStyle,
                ),
              ),
              ClipRect(
              ...
              Container(
                ...
                child: const Text(
                  '圆⻆矩形裁剪，可容纳一个子组件，并将其进行圆⻆矩形裁切，指定borderRadius作为边⻆半径。',
                  style: descStyle,
                ),
              ),
              ClipRRect(
              ...
              Container(
                ...
                child: const Text(
                  '路径裁剪，可容纳一个子组件，并将其按指定路径进行裁切。可自定义路径形状，是一个很灵活的裁剪组件。',
                  style: descStyle,
                ),
              ),
              ClipPath(
